...
$sidebarItems = [
    ...
    //     "title" => $GLOBALS['lang-menu']['sidebar']['panel-home'],
    //     "icon" => "house-fill",
    //     "local" => true,
    //     "items" => null
    // ],
    ...
    // 'calculator' => [
    //     "module" => 'calculator',
    //     "link" => $GLOBALS['routes']['calculator'][$GLOBALS['lang']],
    ...
    // 'flayers' => [
    //     "module" => 'flayers',
    //     "link" => $GLOBALS['routes']['flayers'][$GLOBALS['lang']],
    ...
    // 'accounts' => [
    //     "module" => 'accounts',
    //     "link" => $GLOBALS['routes']['accounts'][$GLOBALS['lang']],
    ...
    // 'customers' => [
    //     "module" => 'customers',
    //     "link" => $GLOBALS['routes']['customers'][$GLOBALS['lang']],
    ...
    // 'users' => [
    //     "module" => 'users',
    //     "link" => $GLOBALS['routes']['users'][$GLOBALS['lang']],
    ...
    // 'records' => [
    //     "module" => 'records',
    //     "link" => $GLOBALS['routes']['records'][$GLOBALS['lang']],
    ...
    // 'security' => [
    //     "module" => 'security',
    //     "link" => $GLOBALS['routes']['security'][$GLOBALS['lang']],
    ...
    // 'manage' => [
    //     "module" => 'manage',
    //     "link" => $GLOBALS['routes']['manage'][$GLOBALS['lang']],
