...
$GLOBALS['lang-email']['login'] = [
    ...
    "text-details" => "Detalles del inicio de sesión",
    ...
    "device-unknown" => "Navegador desconocido",
    "device-desktop" => "Ordenador de Escritorio",
    "device-mobile" => "Dispositivo Móvil",
    "device" => "[[browser]] a través de [[device]]",
];